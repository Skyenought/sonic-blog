...
func (c *CategoryHandler) Categories(_ctx context.Context, ctx *hzapp.RequestContext, model template.Model) (string, error) {
	return c.CategoryModel.ListCategories(_ctx, model)
}

func (c *CategoryHandler) CategoryDetail(_ctx context.Context, ctx *hzapp.RequestContext, model template.Model) (string, error) {
...
func (c *CategoryHandler) CategoryDetailPage(_ctx context.Context, ctx *hzapp.RequestContext, model template.Model) (string, error) {
	slug, err := util.ParamString(_ctx, ctx, "slug")
	if err != nil {
		return "", err
	}

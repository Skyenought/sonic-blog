...
func (p *JournalHandler) JournalsPage(_ctx context.Context, ctx *hzapp.RequestContext, model template.Model) (string, error) {
...
func (p *JournalHandler) Journals(_ctx context.Context, ctx *hzapp.RequestContext, model template.Model) (string, error) {

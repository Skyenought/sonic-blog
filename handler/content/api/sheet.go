...
func (s *SheetHandler) ListTopComment(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
...
func (s *SheetHandler) ListChildren(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
	sheetID, err := util.ParamInt32(_ctx, ctx, "sheetID")
	if err != nil {
		return nil, err
	}
...
func (s *SheetHandler) ListCommentTree(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
	sheetID, err := util.ParamInt32(_ctx, ctx, "sheetID")
	if err != nil {
		return nil, err
	}
...
func (s *SheetHandler) ListComment(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
	sheetID, err := util.ParamInt32(_ctx, ctx, "sheetID")
	if err != nil {
		return nil, err
	}
...
func (s *SheetHandler) CreateComment(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {

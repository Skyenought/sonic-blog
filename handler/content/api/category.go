...
func (c *CategoryHandler) ListCategories(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
...
func (c *CategoryHandler) ListPosts(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {

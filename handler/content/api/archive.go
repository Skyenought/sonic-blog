...
func (a *ArchiveHandler) ListYearArchives(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
...
func (a *ArchiveHandler) ListMonthArchives(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
	posts, err := a.PostService.GetByStatus(_ctx, []consts.PostStatus{consts.PostStatusPublished}, consts.PostTypePost, nil)
	if err != nil {
		return nil, err
	}

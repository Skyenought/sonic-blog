...
func (f *FeedHandler) Feed(_ctx context.Context, ctx *hzapp.RequestContext, model template.Model) (string, error) {
...
func (f *FeedHandler) CategoryFeed(_ctx context.Context, ctx *hzapp.RequestContext, model template.Model) (string, error) {
...
func (f *FeedHandler) Atom(_ctx context.Context, ctx *hzapp.RequestContext, model template.Model) (string, error) {
...
func (f *FeedHandler) CategoryAtom(_ctx context.Context, ctx *hzapp.RequestContext, model template.Model) (string, error) {
...
func (f *FeedHandler) Robots(_ctx context.Context, ctx *hzapp.RequestContext, model template.Model) (string, error) {
	ctx.Header("Content-Type", "text/plain;charset=utf-8")
	return "common/web/robots", nil
}

func (f *FeedHandler) SitemapXML(_ctx context.Context, ctx *hzapp.RequestContext, model template.Model) (string, error) {
...
func (f *FeedHandler) SitemapHTML(_ctx context.Context, ctx *hzapp.RequestContext, model template.Model) (string, error) {
	posts, _, err := f.PostService.Page(_ctx, param.PostQuery{
		Page:     param.Page{PageNum: 0, PageSize: int(^uint(0) >> 1)},
		Sort:     &param.Sort{Fields: []string{"createTime,desc"}},
		Statuses: []*consts.PostStatus{consts.PostStatusPublished.Ptr()},

...
func (p *PhotoHandler) PhotosPage(_ctx context.Context, ctx *hzapp.RequestContext, model template.Model) (string, error) {
...
func (p *PhotoHandler) Phtotos(_ctx context.Context, ctx *hzapp.RequestContext, model template.Model) (string, error) {

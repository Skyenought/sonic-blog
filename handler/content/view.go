...
func (v *ViewHandler) Admin(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
	// TODO
	return nil, nil
}

func (v *ViewHandler) Version(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
	return consts.SonicVersion, nil
}

func (v *ViewHandler) Install(_ctx context.Context, ctx *hzapp.RequestContext) {
...
func (v *ViewHandler) Logo(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
...
func (v *ViewHandler) Favicon(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
...
func (v *ViewHandler) Authenticate(_ctx context.Context, ctx *hzapp.RequestContext, model template.Model) (string, error) {
...
func (v *ViewHandler) authenticateCategory(_ctx context.Context, ctx *hzapp.RequestContext, slug, password, token string) (string, error) {
...
func (v *ViewHandler) authenticatePost(_ctx context.Context, ctx *hzapp.RequestContext, slug, password, token string) (string, error) {
...
func (v *ViewHandler) authenticateErr(_ctx context.Context, ctx *hzapp.RequestContext, model template.Model, aType string, slug string, err error) (string, error) {
	model["type"] = aType
	model["slug"] = slug

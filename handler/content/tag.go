...
func (t *TagHandler) Tags(_ctx context.Context, ctx *hzapp.RequestContext, model template.Model) (string, error) {
	return t.TagModel.Tags(_ctx, model)
}

func (t *TagHandler) TagPost(_ctx context.Context, ctx *hzapp.RequestContext, model template.Model) (string, error) {
...
func (t *TagHandler) TagPostPage(_ctx context.Context, ctx *hzapp.RequestContext, model template.Model) (string, error) {
	slug, err := util.ParamString(_ctx, ctx, "slug")
	if err != nil {
		return "", err
	}

...
func (s *SearchHandler) Search(_ctx context.Context, ctx *hzapp.RequestContext, model template.Model) (string, error) {
	return s.search(_ctx, ctx, 0, model)
}

func (s *SearchHandler) PageSearch(_ctx context.Context, ctx *hzapp.RequestContext, model template.Model) (string, error) {
...
func (s *SearchHandler) search(_ctx context.Context, ctx *hzapp.RequestContext, pageNum int, model template.Model) (string, error) {

...
func (p *PostCommentHandler) ListPostComment(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
...
func (p *PostCommentHandler) ListPostCommentLatest(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
...
func (p *PostCommentHandler) ListPostCommentAsTree(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
...
func (p *PostCommentHandler) ListPostCommentWithParent(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
	postID, err := util.ParamInt32(_ctx, ctx, "postID")
	if err != nil {
		return nil, err
	}
...
func (p *PostCommentHandler) CreatePostComment(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
...
func (p *PostCommentHandler) UpdatePostComment(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
...
func (p *PostCommentHandler) UpdatePostCommentStatus(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
	commentID, err := util.ParamInt32(_ctx, ctx, "commentID")
	if err != nil {
		return nil, err
	}
...
func (p *PostCommentHandler) UpdatePostCommentStatusBatch(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
	strStatus, err := util.ParamString(_ctx, ctx, "status")
	if err != nil {
		return nil, err
	}
...
func (p *PostCommentHandler) DeletePostComment(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
	commentID, err := util.ParamInt32(_ctx, ctx, "commentID")
	if err != nil {
		return nil, err
	}
...
func (p *PostCommentHandler) DeletePostCommentBatch(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
	ids := make([]int32, 0)
	err := ctx.BindAndValidate(&ids)
	if err != nil {
		return nil, xerr.WithStatus(err, xerr.StatusBadRequest).WithMsg("post ids error")

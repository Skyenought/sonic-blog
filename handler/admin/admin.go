...
func (a *AdminHandler) IsInstalled(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
	return a.OptionService.GetOrByDefaultWithErr(_ctx, property.IsInstalled, false)
}

func (a *AdminHandler) AuthPreCheck(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
...
func (a *AdminHandler) Auth(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
	var loginParam param.LoginParam
	err := ctx.BindAndValidate(&loginParam)
	if err != nil {
		e := validator.ValidationErrors{}
...
func (a *AdminHandler) LogOut(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
	err := a.AdminService.ClearToken(_ctx)
	return nil, err
}

func (a *AdminHandler) SendResetCode(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
...
func (a *AdminHandler) RefreshToken(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
...
func (a *AdminHandler) GetEnvironments(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
	return a.AdminService.GetEnvironments(_ctx), nil
}

func (a *AdminHandler) GetLogFiles(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {

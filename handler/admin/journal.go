...
func (j *JournalHandler) ListLatestJournal(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
...
func (j *JournalHandler) CreateJournal(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
...
func (j *JournalHandler) UpdateJournal(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
	var journalParam param.Journal
	err := ctx.BindAndValidate(&journalParam)
	if err != nil {
		e := validator.ValidationErrors{}
...
func (j *JournalHandler) DeleteJournal(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
	journalID, err := util.ParamInt32(_ctx, ctx, "journalID")
	if err != nil {
		return nil, err
	}

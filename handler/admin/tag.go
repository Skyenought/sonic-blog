...
func (t *TagHandler) ListTags(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
	sort := param.Sort{}
...
func (t *TagHandler) GetTagByID(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
...
func (t *TagHandler) CreateTag(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
	tagParam := &param.Tag{}
...
func (t *TagHandler) UpdateTag(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
	id, err := util.ParamInt32(_ctx, ctx, "id")
	if err != nil {
		return nil, err
	}
...
func (t *TagHandler) DeleteTag(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
	id, err := util.ParamInt32(_ctx, ctx, "id")
	if err != nil {
		return nil, err
	}

...
func (u *UserHandler) GetCurrentUserProfile(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
...
func (u *UserHandler) UpdateUserProfile(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
...
func (u *UserHandler) UpdatePassword(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
...
func (u *UserHandler) GenerateMFAQRCode(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
	type Param struct {
...
func (u *UserHandler) UpdateMFA(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
	type Param struct {

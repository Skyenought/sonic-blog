...
func (a *AttachmentHandler) QueryAttachment(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
	queryParam := &param.AttachmentQuery{}
	err := ctx.BindAndValidate(queryParam)
	if err != nil {
		return nil, xerr.WithStatus(err, xerr.StatusBadRequest).WithMsg("param error ")
	}
	attachments, totalCount, err := a.AttachmentService.Page(_ctx, queryParam)
	if err != nil {
		return nil, err
	}
...
func (a *AttachmentHandler) GetAttachmentByID(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
...
func (a *AttachmentHandler) UploadAttachment(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
...
func (a *AttachmentHandler) UploadAttachments(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
...
func (a *AttachmentHandler) UpdateAttachment(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
	id, err := util.ParamInt32(_ctx, ctx, "id")
	if err != nil {
		return nil, err
	}
...
func (a *AttachmentHandler) DeleteAttachment(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
	id, err := util.ParamInt32(_ctx, ctx, "id")
	if err != nil {
		return nil, err
	}
...
func (a *AttachmentHandler) DeleteAttachmentInBatch(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
	ids := make([]int32, 0)
...
func (a *AttachmentHandler) GetAllMediaType(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
	return a.AttachmentService.GetAllMediaTypes(_ctx)
}

func (a *AttachmentHandler) GetAllTypes(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {

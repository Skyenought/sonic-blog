...
func (c *CategoryHandler) GetCategoryByID(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
...
func (c *CategoryHandler) ListAllCategory(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
...
func (c *CategoryHandler) ListAsTree(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
	var sort param.Sort
...
func (c *CategoryHandler) CreateCategory(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
...
func (c *CategoryHandler) UpdateCategory(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
	var categoryParam param.Category
	err := ctx.BindAndValidate(&categoryParam)
	if err != nil {
		e := validator.ValidationErrors{}
...
func (c *CategoryHandler) UpdateCategoryBatch(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
...
func (c *CategoryHandler) DeleteCategory(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
	categoryID, err := util.ParamInt32(_ctx, ctx, "categoryID")
	if err != nil {
		return nil, err
	}

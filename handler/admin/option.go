...
func (o *OptionHandler) ListAllOptions(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
	return o.OptionService.ListAllOption(_ctx)
}

func (o *OptionHandler) SaveOption(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
...
func (o *OptionHandler) ListAllOptionsAsMap(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
...
func (o *OptionHandler) ListAllOptionsAsMapWithKey(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
	keys := make([]string, 0)
...
func (o *OptionHandler) SaveOptionWithMap(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {

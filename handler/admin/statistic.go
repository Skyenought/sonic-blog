...
func (s *StatisticHandler) Statistics(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
	return s.StatisticService.Statistic(_ctx)
}

func (s *StatisticHandler) StatisticsWithUser(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {

...
func (l *LinkHandler) ListLinks(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
	sort := param.Sort{}
...
func (l *LinkHandler) GetLinkByID(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
...
func (l *LinkHandler) CreateLink(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
...
func (l *LinkHandler) UpdateLink(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
	id, err := util.ParamInt32(_ctx, ctx, "id")
	if err != nil {
		return nil, err
	}
...
func (l *LinkHandler) DeleteLink(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
	id, err := util.ParamInt32(_ctx, ctx, "id")
	if err != nil {
		return nil, err
	}
...
func (l *LinkHandler) ListLinkTeams(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {

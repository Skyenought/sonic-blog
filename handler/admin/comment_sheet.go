...
func (s *SheetCommentHandler) ListSheetComment(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
...
func (s *SheetCommentHandler) ListSheetCommentLatest(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
...
func (s *SheetCommentHandler) ListSheetCommentAsTree(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
...
func (s *SheetCommentHandler) ListSheetCommentWithParent(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
	postID, err := util.ParamInt32(_ctx, ctx, "sheetID")
	if err != nil {
		return nil, err
	}
...
func (s *SheetCommentHandler) CreateSheetComment(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
...
func (s *SheetCommentHandler) UpdateSheetCommentStatus(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
...
func (s *SheetCommentHandler) UpdateSheetCommentStatusBatch(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
...
func (s *SheetCommentHandler) DeleteSheetComment(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
	commentID, err := util.ParamInt32(_ctx, ctx, "commentID")
	if err != nil {
		return nil, err
	}
...
func (s *SheetCommentHandler) DeleteSheetCommentBatch(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
	ids := make([]int32, 0)
	err := ctx.BindAndValidate(&ids)
	if err != nil {
		return nil, xerr.WithStatus(err, xerr.StatusBadRequest).WithMsg("post ids error")

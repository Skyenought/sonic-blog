...
func (p *PhotoHandler) ListPhoto(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
	sort := param.Sort{}
...
func (p *PhotoHandler) PagePhotos(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
	type Param struct {
		param.Page
		param.Sort
	}
...
func (p *PhotoHandler) GetPhotoByID(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
...
func (p *PhotoHandler) CreatePhoto(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
...
func (p *PhotoHandler) CreatePhotoBatch(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
...
func (p *PhotoHandler) UpdatePhoto(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
	id, err := util.ParamInt32(_ctx, ctx, "id")
	if err != nil {
		return nil, err
	}
...
func (p *PhotoHandler) DeletePhoto(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
	id, err := util.ParamInt32(_ctx, ctx, "id")
	if err != nil {
		return nil, err
	}
...
func (p *PhotoHandler) DeletePhotoBatch(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
...
func (p *PhotoHandler) ListPhotoTeams(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {

...
func (p *PostHandler) ListPosts(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
...
func (p *PostHandler) ListLatestPosts(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
...
func (p *PostHandler) ListPostsByStatus(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
...
func (p *PostHandler) GetByPostID(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
...
func (p *PostHandler) CreatePost(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
...
func (p *PostHandler) UpdatePost(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
	var postParam param.Post
	err := ctx.BindAndValidate(&postParam)
	if err != nil {
		e := validator.ValidationErrors{}
...
func (p *PostHandler) UpdatePostStatus(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
	postIDStr := ctx.Param("postID")
	postID, err := strconv.ParseInt(postIDStr, 10, 32)
	if err != nil {
		return nil, xerr.WithStatus(err, xerr.StatusBadRequest).WithMsg("Parameter error")
...
func (p *PostHandler) UpdatePostStatusBatch(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
	statusStr, err := util.ParamString(_ctx, ctx, "status")
	if err != nil {
		return nil, err
	}
...
func (p *PostHandler) UpdatePostDraft(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
...
func (p *PostHandler) DeletePost(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
	postID, err := util.ParamInt32(_ctx, ctx, "postID")
	if err != nil {
		return nil, err
	}
...
func (p *PostHandler) DeletePostBatch(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
...
func (p *PostHandler) PreviewPost(_ctx context.Context, ctx *hzapp.RequestContext) {
	postID, err := util.ParamInt32(_ctx, ctx, "postID")
	if err != nil {

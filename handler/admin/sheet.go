...
func (s *SheetHandler) GetSheetByID(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
...
func (s *SheetHandler) ListSheet(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
...
func (s *SheetHandler) IndependentSheets(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
	return s.SheetService.ListIndependentSheets(_ctx)
}

func (s *SheetHandler) CreateSheet(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
...
func (s *SheetHandler) UpdateSheet(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
	var sheetParam param.Sheet
	err := ctx.BindAndValidate(&sheetParam)
	if err != nil {
		e := validator.ValidationErrors{}
...
func (s *SheetHandler) UpdateSheetStatus(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
	sheetID, err := util.ParamInt32(_ctx, ctx, "sheetID")
	if err != nil {
		return nil, err
	}
...
func (s *SheetHandler) UpdateSheetDraft(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
	sheetID, err := util.ParamInt32(_ctx, ctx, "sheetID")
	if err != nil {
		return nil, err
	}
...
func (s *SheetHandler) DeleteSheet(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
	sheetID, err := util.ParamInt32(_ctx, ctx, "sheetID")
	if err != nil {
		return nil, err
	}
...
func (s *SheetHandler) PreviewSheet(_ctx context.Context, ctx *hzapp.RequestContext) {
	sheetID, err := util.ParamInt32(_ctx, ctx, "sheetID")
	if err != nil {

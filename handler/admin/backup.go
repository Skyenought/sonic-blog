...
func (b *BackupHandler) GetWorkDirBackup(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
...
func (b *BackupHandler) GetDataBackup(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
	filename, err := util.MustGetQueryString(_ctx, ctx, "filename")
	if err != nil {
		return nil, err
	}
...
func (b *BackupHandler) GetMarkDownBackup(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
	filename, err := util.MustGetQueryString(_ctx, ctx, "filename")
	if err != nil {
		return nil, err
	}
...
func (b *BackupHandler) BackupWholeSite(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
...
func (b *BackupHandler) ListBackups(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
	return b.BackupService.ListFiles(_ctx, config.BackupDir, service.WholeSite)
}

func (b *BackupHandler) ListToBackupItems(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
	return b.BackupService.ListToBackupItems(_ctx)
}

func (b *BackupHandler) HandleWorkDir(_ctx context.Context, ctx *hzapp.RequestContext) {
...
func (b *BackupHandler) DownloadBackups(_ctx context.Context, ctx *hzapp.RequestContext) {
...
func (b *BackupHandler) DeleteBackups(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
	filename, err := util.MustGetQueryString(_ctx, ctx, "filename")
	if err != nil {
		return nil, err
	}
...
func (b *BackupHandler) ImportMarkdown(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
...
func (b *BackupHandler) ExportData(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
	return b.BackupService.ExportData(_ctx)
}

func (b *BackupHandler) HandleData(_ctx context.Context, ctx *hzapp.RequestContext) {
	path := string(ctx.URI().Path())
...
func (b *BackupHandler) ListExportData(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
	return b.BackupService.ListFiles(_ctx, config.DataExportDir, service.JSONData)
}

func (b *BackupHandler) DownloadData(_ctx context.Context, ctx *hzapp.RequestContext) {
	filename := ctx.Param("path")
	if filename == "" {
		ctx.AbortWithStatusJSON(http.StatusBadRequest, &dto.BaseDTO{
			Status:  http.StatusBadRequest,
...
func (b *BackupHandler) DeleteDataFile(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
...
func (b *BackupHandler) ExportMarkdown(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
...
func (b *BackupHandler) ListMarkdowns(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
	return b.BackupService.ListFiles(_ctx, config.BackupMarkdownDir, service.Markdown)
}

func (b *BackupHandler) DeleteMarkdowns(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error) {
	filename, err := util.MustGetQueryString(_ctx, ctx, "filename")
	if err != nil {
		return nil, err
	}
...
func (b *BackupHandler) DownloadMarkdown(_ctx context.Context, ctx *hzapp.RequestContext) {
...
type wrapperHandler func(_ctx context.Context, ctx *hzapp.RequestContext) (interface{}, error)

func wrapHandler(handler wrapperHandler) hzapp.HandlerFunc {
